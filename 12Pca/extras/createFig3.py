...
#ax.scatter(label0Mat[:,0].flatten().A[0],label0Mat[:,1].flatten().A[0], marker='^', s=90)
#ax.scatter(label1Mat[:,0].flatten().A[0],label1Mat[:,1].flatten().A[0], marker='o', s=50,  c='red')
#ax.scatter(label2Mat[:,0].flatten().A[0],label2Mat[:,1].flatten().A[0], marker='v', s=50,  c='yellow')
